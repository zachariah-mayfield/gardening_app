...
class Plant(BaseModel):
    ...
    id: int = None  # Optional: ID will be auto-generated by PostgreSQL
...
def get_plants(db: Session = Depends(get_db)):  # Inject database session
    ...
    Returns:
        List[Plant]: All plants in the database
    """
...
async def add_plant(
    plant: Plant,  # Request body validated against Plant model
    ...
    Args:
        plant (Plant): Plant data from request body
        db (Session): Database session for PostgreSQL

    Returns:
        Plant: Newly created plant with database ID
    ...
    try:
        ...
        db_plant = models.Plant(
            name=plant.name.strip(), description=plant.description.strip()
        )
...
@router.put("/plants/id/{plant_id}", response_model=Plant)
async def update_plant_by_id(
    plant_id: int, updated_plant: Plant, db: Session = Depends(get_db)
):
    """
    ...
    Args:
        ...
        updated_plant (Plant): New plant data
...
@router.put("/plants/name/{plant_name}", response_model=Plant)
async def update_plant_by_name(
    plant_name: str, updated_plant: Plant, db: Session = Depends(get_db)
):
    """
