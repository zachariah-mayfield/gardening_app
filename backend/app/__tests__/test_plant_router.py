...
def test_create_plant_success():
    ...
    response = client.post(
        "/api/v1/plants", json={"name": "TestPlant1", "description": "desc1"}
    )
...
def test_create_plant_duplicate_name():
    ...
    response = client.post(
        "/api/v1/plants", json={"name": "TestPlantDup", "description": "desc again"}
    )
...
def test_update_plant_by_id_success():
    ...
    create = client.post(
        "/api/v1/plants", json={"name": "TestPlantUpdateID", "description": "desc"}
    )
    plant_id = create.json()["id"]
    response = client.put(
        f"/api/v1/plants/id/{plant_id}",
        json={"name": "UpdatedNameID", "description": "newdesc"},
    )
    assert response.status_code == 200
    data = response.json()
...
def test_update_plant_by_name_success():
    ...
    client.post(
        "/api/v1/plants", json={"name": "TestPlantUpdateName", "description": "desc"}
    )
    response = client.put(
        "/api/v1/plants/name/TestPlantUpdateName",
        json={"name": "UpdatedNameByName", "description": "desc2"},
    )
    assert response.status_code == 200
    data = response.json()
...
def test_update_nonexistent_plant_by_id():
    ...
    response = client.put(
        "/api/v1/plants/id/999999", json={"name": "NoPlant", "description": "none"}
    )
...
def test_update_nonexistent_plant_by_name():
    ...
    response = client.put(
        ...
        json={"name": "NoPlant", "description": "none"},
    )
    assert response.status_code == 404  # Should return 404 Not Found
...
def test_delete_plant_by_id():
    ...
    response = client.post(
        "/api/v1/plants", json={"name": "TestDeleteID", "description": "desc"}
    )
...
def test_delete_plant_by_name():
    ...
    client.post(
        "/api/v1/plants", json={"name": "TestDeleteName", "description": "desc"}
    )
